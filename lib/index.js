...
app.get("/:name", (req, res) => {
    meal.find({name: req.params.name}).then(foodInfo => {
        res.json(foodInfo);
    });
})
...
app.get("/:category", (req, res) => {
    meal.find({category: req.params.category}).then(foodInfo => {
        res.json(foodInfo);
    });
})
...
app.get("/:area", (req, res) => {
    meal.find({area: req.params.area}).then(foodInfo => {
        res.json(foodInfo);
    });
})
...
app.get("/:tags", (req, res) => {
    meal.find({tags: req.params.tags}).then(foodInfo => {
        res.json(foodInfo);
    });
})
/*
